"""
COMPLETE IRIS TEST - Generation + Persistence
...
def test_complete_iris_flow():
    print("=== COMPLETE IRIS TEST WITH PERSISTENCE ===")
                            ...
                            for img in images:
                                if img['id'] == vision_id:
                                    ...
                                    if img_check.status_code == 200:
                                        print("✅ COMPLETE SUCCESS: Image generated and made persistent!")
