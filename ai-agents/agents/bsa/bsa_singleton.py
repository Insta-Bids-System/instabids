...
from agents.bsa.bsa_deepagents import BSA_MAIN_INSTRUCTIONS, BSADeepAgentState, create_bsa_dynamic_prompt
...
class BSASingleton:
    ...
    async def _initialize(cls):
        ...
        try:
            ...
            # Create deep agent with dynamic prompt for context integration
            agent = create_deep_agent(
                tools=tools,
                instructions=create_bsa_dynamic_prompt,  # Now uses dynamic prompt function
                subagents=[
                    bid_search_subagent,
                    market_research_subagent,
                    bid_submission_subagent,
