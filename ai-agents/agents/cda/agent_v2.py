...
class IntelligentContractorDiscoveryAgent:
    ...
    def discover_contractors(self, bid_card_id: str, contractors_needed: int = 5) -> Dict[str, Any]:
        """
        Main CDA function with intelligent matching
        
        Process:
        1. Load bid card data
        2. Use Opus 4 to deeply analyze what customer wants
        3. Search for contractors (3-tier system)
        4. Use Opus 4 to score each contractor
        5. Select best matches with explanations
        """
        try:
            print(f"[CDA v2] Starting intelligent contractor discovery for bid card: {bid_card_id}")
            ...
            print(f"[CDA v2] Opus 4 Analysis Complete:")
            ...
            print("[CDA v2] Searching Tier 1: Internal contractor database...")
            ...
            if tier1_results['success'] and tier1_results['contractors']:
                ...
                print(f"[CDA v2] Found {len(tier1_results['contractors'])} contractors in database")
            
            # Tier 2: Previous contacts
            print("[CDA v2] Searching Tier 2: Previous contractor contacts...")
            ...
            if tier2_results['success'] and tier2_results['contractors']:
                ...
                print(f"[CDA v2] Found {len(tier2_results['contractors'])} previous contacts")
            
            # Tier 3: Web search for new contractors
            if len(all_contractors) < contractors_needed * 2:  # Get extra for better selection
                print("[CDA v2] Searching Tier 3: Web search for new contractors...")
            ...
            print(f"[CDA v2] Discovery complete - Selected {len(selection_result['selected_contractors'])} contractors")
...
if __name__ == "__main__":
    ...
    agent = IntelligentContractorDiscoveryAgent()
    
    # Test with mom & pop preference bid card
