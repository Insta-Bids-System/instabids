"""
Intelligent Contractor Matcher using LLM
Uses Claude/GPT-4 to make nuanced matching decisions
"""
import os
import json
...
class IntelligentContractorMatcher:
    ...
    def __init__(self, llm_provider: str = "anthropic"):
        ...
        if llm_provider == "anthropic":
            ...
            self.model = "claude-opus-4-20250514"  # Most intelligent model
            print("[IntelligentMatcher] Using Claude Opus 4 for maximum intelligence")
    ...
    def score_contractor_match(self, 
        ...
        if self.llm_provider == "anthropic":
            ...
            score_analysis = response.content[0].text
    ...
    def rank_and_select_contractors(self,
        ...
        """
        print(f"[IntelligentMatcher] Analyzing bid card requirements...")
