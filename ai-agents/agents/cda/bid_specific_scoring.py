...
class BidSpecificScoringEngine:
    ...
    def _check_special_requirements(self, contractor: Dict[str, Any], requirements: List[str]) -> float:
        ...
        for requirement in requirements:
            if requirement == 'licensed' and contractor.get('license_number'):
                score += 5.0
            elif requirement == 'insured' and contractor.get('insurance_verified'):
                score += 5.0
            elif requirement == 'bonded' and contractor.get('bonded'):
                score += 5.0
