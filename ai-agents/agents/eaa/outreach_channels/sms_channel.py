...
class SMSChannel:
    ...
    def _send_production_sms(self, to_phone: str, message_data: Dict[str, Any], 
        ...
        try:
            ...
            message = self.client.messages.create(
                ...
                status_callback=f"{os.getenv('BASE_URL', 'http://localhost:8000')}/api/eaa/webhook/sms-status"
            )
    ...
    def track_delivery(self, message_id: str, twilio_sid: str = None) -> Dict[str, Any]:
