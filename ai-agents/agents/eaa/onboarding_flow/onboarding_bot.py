...
class OnboardingBot:
    ...
    def start_onboarding(self, contractor_email: str, source_campaign: str = None) -> Dict[str, Any]:
        """
    ...
    def _process_info_collection_response(self, onboarding_record: Dict[str, Any], 
        ...
        if missing_fields:
            ...
            missing_info_result = self._request_missing_info(onboarding_record, missing_fields)
            return {
                'success': True,
    ...
    def _send_info_collection_form(self, onboarding_record: Dict[str, Any]) -> Dict[str, Any]:
        ...
        form_message = f"""
        Subject: Complete Your Instabids Contractor Profile
        
        Great! Let's get your contractor profile set up.
        
        Please complete your profile using the secure form below:
        {form_link}
        ...
        Once submitted, we'll verify your information and activate your profile.
