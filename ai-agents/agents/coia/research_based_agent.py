...
from .prompts import COIA_SYSTEM_PROMPT
from ..enrichment.playwright_website_enricher import PlaywrightWebsiteEnricher, EnrichedContractorData
...
If everything looks good, just say "yes" and I'll create your complete contractor profile. If anything needs correction, let me know what to update."""
    ...
    async def _handle_research_confirmation(self, state: CoIAConversationState, 
        ...
        if confirmed:
            ...
            if contractor_id:
                response = f"""Perfect! I've created your complete contractor profile using the information from your website.
