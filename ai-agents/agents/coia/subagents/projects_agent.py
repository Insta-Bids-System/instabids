...
def find_matching_projects(staging_or_profile: Union[str, Dict[str, Any]], radius_miles: Optional[int] = None) -> List[Dict[str, Any]]:
    """
    ...
    Returns: list of project dicts (max ~3 as per underlying tool default)
    """
    try:
