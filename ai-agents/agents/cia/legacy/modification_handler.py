...
class ModificationHandler:
    ...
    def detect_modification(self, message: str) -> tuple[bool, dict[str, Any]]:
        ...
        if message is None:
            message = ""
            print(f"[MODIFICATION_HANDLER] WARNING: message was None, using empty string")
        ...
        # More lenient check
        any(indicator in message_lower for indicator in modification_indicators)
            ...
            for pattern in config["patterns"]:
                ...
                if match:
                    ...
                    if mod_type == "budget":
                        ...
                        elif "emergency" in message_lower or "asap" in message_lower or "urgent" in message_lower or "immediately" in message_lower:
    ...
    def _normalize_material(self, material: str) -> str:
        ...
        # Safety check for None material
        if material is None:
            material = ""
            print(f"[MODIFICATION_HANDLER] WARNING: material was None, using empty string")
    ...
    def _infer_project_type(self, message: str) -> Optional[str]:
        ...
        if message is None:
            message = ""
            print(f"[MODIFICATION_HANDLER] WARNING: message was None in _infer_project_type, using empty string")
    ...
    def validate_modifications(self, modifications: dict[str, Any],
        ...
        if "materials" in modifications and not modifications["materials"]:
