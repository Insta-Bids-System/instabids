...
def test_form_detection():
    ...
    with sync_playwright() as p:
        ...
        try:
            sites = [
                {"name": "Simple", "url": "http://localhost:8001/simple-contractor/index.html"},
                {"name": "Pro", "url": "http://localhost:8002/pro-contractor/index.html"},
                {"name": "Enterprise", "url": "http://localhost:8003/enterprise-contractor/index.html"},
                {"name": "Modern", "url": "http://localhost:8004/modern-contractor/index.html"}
            ]
