        ...
        if response.status_code == 200:
            ...
            if bid_cards:
                ...
                if "progress" in first_card and "bids_received" not in first_card:
                    print("CONFIRMED: API still using OLD field names (progress, target_bids)")
                    print("NEED: Switch to NEW field names (bids_received, progress_percentage)")
                elif "bids_received" in first_card:
                    print("CONFIRMED: API using NEW field names (bids_received, progress_percentage)")
