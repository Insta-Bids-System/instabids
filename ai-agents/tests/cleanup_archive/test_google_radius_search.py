...
def create_test_bid_card():
    ...
    try:
        ...
        if result.data:
            ...
            print("    Project: Lawn Care")
            print("    Location: Coconut Creek, FL 33442")
            print("    Budget: $100-200/month")
        ...
        print("[OK] Using mock bid card for testing")
        return bid_card_id, bid_card_data
        ...
        try:
            ...
            if result["success"]:
                ...
                if result["tier_results"]["tier1_internal"] >= 5:
                    print("    -> Tier 1 had enough contractors, stopped there")
                elif result["tier_results"]["tier1_internal"] + result["tier_results"]["tier2_previous"] >= 5:
                    print("    -> Tier 1+2 had enough contractors, stopped there")
                else:
                    print("    -> Needed Tier 3 web search to find enough contractors")
