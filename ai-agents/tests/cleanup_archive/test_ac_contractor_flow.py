...
def create_ac_installation_bid_card():
    ...
    if response.status_code == 200:
        ...
        print("   Location: Miami, FL 33139")
        print("   Budget: $8,000 - $12,000")
...
def test_contractor_chat_onboarding():
    ...
    if response.status_code == 200:
        ...
        if response2.status_code == 200:
            ...
            print("[SUCCESS] Profile building")
            ...
            if response3.status_code == 200:
                ...
                print("[SUCCESS] Service area registered")
...
def test_complete_flow():
    ...
    print("[SUCCESS] Job Search Tested: Yes")
