"""
SIMPLE COIA TEST - TurfGrass Artificial Solutions
...
async def test_complete_turfgrass():
    print("=" * 80)
    print("COMPLETE COIA TEST - TurfGrass Artificial Solutions (EXACT COMPANY NAME)")
    print("Full workflow with database save")
    print("=" * 80)
    
    from agents.coia.tools import coia_tools
    
    # Use the exact company name requested
    ...
    try:
        ...
        print("SUCCESS - Google Business Search")
    ...
    try:
        ...
        print("SUCCESS - Tavily Web Research")
    ...
    try:
        ...
        if profile_result:
            print("SUCCESS - PROFILE CREATED AND SAVED TO DATABASE")
