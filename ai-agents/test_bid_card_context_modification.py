...
def test_bid_card_modifications(thread_id, original_bid_card):
    ...
    print(f"[CUSTOMER] I want to increase my budget to $60,000-$75,000")
...
def test_memory_persistence(thread_id):
    ...
    print(f"[CUSTOMER] Can you remind me what we discussed about the timeline?")
...
def main():
    ...
    results = {
        ...
        "Bid Card Modifications": "✅ PASS" if modification_result == True else "⚠️ PARTIAL" if modification_result == "partial" else "❌ FAIL",
