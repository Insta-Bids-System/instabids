#!/usr/bin/env python3
"""
Check-in Manager Core Logic Test - Clean Version
Tests the mathematical and logical components without database dependencies or emojis
"""
    ...
    try:
        ...
        for scenario in scenarios:
            ...
            if strategy.expected_total_responses < scenario['bids_needed'] * 0.5:
                print(f"  WARNING: Low expected responses ({strategy.expected_total_responses:.1f} < {scenario['bids_needed'] * 0.5})")
            ...
            if strategy.urgency_level.value != expected_urgency:
                print(f"  WARNING: Unexpected urgency level ({strategy.urgency_level.value} vs expected {expected_urgency})")
...
def main():
    ...
    try:
        ...
        if passed == total:
            ...
            print("Mathematical logic is 100% working!")
