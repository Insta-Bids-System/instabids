...
async def get_simple_bid_card(bid_card_id: str):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Error retrieving bid card: {str(e)}")
...
async def list_simple_bid_cards(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Error listing bid cards: {str(e)}")