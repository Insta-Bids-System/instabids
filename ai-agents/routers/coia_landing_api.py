    ...
    try:
        ...
        if use_deepagents:
            ...
            da_input = {
                ...
                "context": restored_state  # Full restored context
            }
        ...
        if use_deepagents:
            ...
            try:
                    ...
                    if messages:
                        ...
                        if hasattr(last_message, 'content'):
                            ...
                            if "JM Holiday Lighting" in response_message:
                                ...
                                company_name = extract_company_name_quick(request.message)[0] or "your business"
                        else:
                ...
                # If no company name from DeepAgents, try extraction
                if not company_name:
                    company_name, location_hint = extract_company_name_quick(request.message)
                    company_name = company_name or "your business"
