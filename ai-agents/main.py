...
try:
    ...
    from agents.iris.agent import router as iris_unified_router
    ...
    app.include_router(iris_unified_router, prefix="/api/iris")  # Unified IRIS agent with complete context
