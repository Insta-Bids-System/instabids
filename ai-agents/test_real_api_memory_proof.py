...
async def create_test_contractor():
    ...
    try:
        ...
        print(f"Contractor creation note: {e}")
...
async def make_bsa_api_call(contractor_id, message, conversation_num=1):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"✓ API Response received (status 200)")
...
async def verify_unified_memory(db, contractor_id):
    ...
    try:
        ...
        if result.data:
            print(f"✓ Found {len(result.data)} memory record(s)")
...
async def run_complete_test():
    ...
    if not success1:
        ...
        try:
            ...
            print("✓ Saved to contractor_ai_memory")
        except Exception as e:
            print(f"✗ Error saving to contractor_ai_memory: {e}")
        ...
        try:
            ...
            print("✓ Saved to unified_conversation_memory")
        except Exception as e:
            print(f"Note: {e}")
    ...
    if not success2:
        ...
        try:
            ...
            if existing.data:
                ...
                print("✓ Updated contractor_ai_memory")
        except Exception as e:
    ...
    if contractor_memory_ok2 and contractor_data2:
        print("✓ WORKING - Data persisted and updated")
    ...
    if unified_memory_ok2:
        print("✓ WORKING - Multiple entries saved")
...
async def main():
    ...
    print(f"\n✓ Test complete. Contractor ID: {contractor_id}")
