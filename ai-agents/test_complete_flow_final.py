...
def test_complete_flow():
    ...
    try:
        ...
        if vision_resp.status_code == 200:
            ...
            print(f"   [OK] Claude Vision analyzed image successfully")
    ...
    try:
        ...
        if gen_resp.status_code == 200:
            ...
            print(f"   [SUCCESS] Dream space generated successfully!")
            ...
            if images_resp.status_code == 200:
                ...
                if len(vision_images) > 0:
                    ...
                    print(f"   [ERROR] No AI-generated vision images found!")
