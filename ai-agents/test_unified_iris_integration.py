...
async def test_unified_iris_integration():
    ...
    try:
        ...
        # First, seed some design preferences manually
        design_preferences = {
            "rooms_worked_on": ["kitchen", "bathroom"],
            "style_preferences": ["modern", "farmhouse"],
            "color_preferences": ["white", "gray", "wood"],
            "total_boards": 2,
            "total_images_uploaded": 15,
            "budget_ranges": ["mid-range"],
            "interaction_history": [
                {
                    "timestamp": datetime.now().isoformat(),
                    "room_type": "kitchen",
                    "board_title": "Modern Kitchen Ideas",
                    "images_uploaded": 8
                }
            ]
        }
        
        # Save test preferences to user_memories
        db.client.table("user_memories").insert({
            "user_id": test_user_id,
            "memory_type": "design_preferences", 
            "memory_data": design_preferences,
            "created_at": datetime.now().isoformat(),
            "updated_at": datetime.now().isoformat()
        }).execute()
        
        print("SEEDED design preferences in user_memories")
        
        # 2. Test Image Upload to Unified Storage
        print("\n2. TESTING UNIFIED PHOTO STORAGE")
        print("-" * 40)
        ...
        # 3. Test Full IRIS Conversation with Memory Integration
        print("\n3️⃣ TESTING FULL IRIS CONVERSATION")
        print("-" * 40)
        ...
        # 4. Verify Unified Photo Storage
        print("\n4️⃣ VERIFYING UNIFIED PHOTO STORAGE")
        print("-" * 40)
        ...
        if photo_results.data:
            print(f"✅ Found {len(photo_results.data)} images in unified photo_storage")
            ...
            print("❌ No images found in unified photo_storage")
        
        # 5. Verify Enhanced Memory Updates
        print("\n5️⃣ VERIFYING ENHANCED MEMORY UPDATES")
        print("-" * 40)
        ...
        if memory_results.data:
            ...
            print("✅ Enhanced design preferences updated:")
            ...
            print("❌ No enhanced design preferences found")
        
        # 6. Test Cross-Project Context Loading
        print("\n6️⃣ TESTING CROSS-PROJECT CONTEXT")
        print("-" * 40)
        ...
        if context_found:
            print("✅ IRIS showed cross-project awareness!")
        else:
            print("⚠️ IRIS response may lack cross-project context")
        ...
        print("🧹 Deleted test photos from photo_storage")
        
        # Delete test memories  
        db.client.table("user_memories").delete().eq("user_id", test_user_id).execute()
        print("🧹 Deleted test memories from user_memories")
