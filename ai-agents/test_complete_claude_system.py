...
async def test_complete_claude_system():
    ...
    check_in_manager = ClaudeCheckInManager()
...
async def test_individual_agents():
    ...
    test_project = {
        'project_type': 'pool_installation',
        'location': 'Coral Gables, FL',
        'budget_min': 50000,
        'budget_max': 75000,
        'timeline': 'Start in 2 months',
        'scope_details': 'New infinity pool with spa, LED lighting, and natural stone decking',
        'external_url': 'https://instabids.com/bid-cards/pool-coral-gables-2025'
    }
