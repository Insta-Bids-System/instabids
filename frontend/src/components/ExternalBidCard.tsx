...
import { Calendar, Clock, MapPin, DollarSign, Users, Camera, ArrowRight, Zap } from 'lucide-react';
...
const ExternalBidCard: React.FC<ExternalBidCardProps> = ({ 
  ...
  const getLandingUrl = () => {
    return `https://instabids.com/join?bid=${bidCard.public_token}&src=${source}`;
  };
      ...
      <div className="text-sm space-y-1">
        ...
        {bidCard.photo_urls && bidCard.photo_urls.length > 0 && (
          <div className="text-gray-600">
            📸 {bidCard.photo_urls.length} photos included
          </div>
        )}
        <div className="pt-2">
          <a 
        ...
        <div style={{ padding: '24px' }}>
          ...
          <div style={{ 
            ...
            <div style={{ textAlign: 'center', padding: '12px', backgroundColor: '#f8fafc', borderRadius: '8px' }}>
              ...
              <div style={{ fontSize: '16px', fontWeight: 'bold', color: '#0f172a' }}>{bidCard.budget_display}</div>
            </div>
            
            <div style={{ textAlign: 'center', padding: '12px', backgroundColor: '#f8fafc', borderRadius: '8px' }}>
              <div style={{ fontSize: '12px', color: '#64748b', marginBottom: '4px' }}>TIMELINE</div>
              <div style={{ fontSize: '16px', fontWeight: 'bold', color: '#0f172a' }}>{getUrgencyText(bidCard.urgency)}</div>
            </div>
            
            <div style={{ textAlign: 'center', padding: '12px', backgroundColor: '#f8fafc', borderRadius: '8px' }}>
              <div style={{ fontSize: '12px', color: '#64748b', marginBottom: '4px' }}>CONTRACTORS NEEDED</div>
              <div style={{ fontSize: '16px', fontWeight: 'bold', color: '#0f172a' }}>{bidCard.contractor_count}</div>
            </div>
          </div>
          ...
          <div style={{
            ...
            <div style={{ fontSize: '18px', fontWeight: 'bold', color: '#0c4a6e', marginBottom: '8px' }}>
              🎯 Why InstaBids?
            </div>
            <div style={{ fontSize: '14px', color: '#075985', lineHeight: '1.5' }}>
              ✅ Zero lead fees - pay only when you win<br/>
              ✅ Pre-qualified homeowners ready to hire<br/>
              ✅ Higher win rates than other platforms
            </div>
          </div>
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <div style={{ 
              ...
              No longer pay for leads, only jobs<br/>
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-3 gap-3 mb-6">
          ...
          <div className="text-center">
            ...
            <div className={`text-xs font-semibold px-2 py-1 rounded-full ${getUrgencyColor(bidCard.urgency)}`}>
