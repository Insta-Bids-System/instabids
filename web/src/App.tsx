...
import BackyardImageViewer from "@/pages/BackyardImageViewer";
...
import TestCommunicationPage from "@/pages/TestCommunicationPage";
      ...
      <Router>
        <div className="min-h-screen bg-gray-50">
          <Routes>
            ...
            <Route path="/backyard-image" element={<BackyardImageViewer />} />
