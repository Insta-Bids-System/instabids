...
export default function ContractorDashboard({ contractorId }: ContractorDashboardProps) {
  ...
  const [activeTab, setActiveTab] = useState<'projects' | 'chat' | 'profile'>('projects');
    ...
    try {
      ...
      if (response.ok) {
        ...
        setContractorData({
          ...
          service_areas: ["Pompano Beach", "Fort Lauderdale", "Boca Raton", "Delray Beach", "Boynton Beach"],
          social_media: {
  ...
  const loadProjects = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:8008/api/contractors/${contractorId}/projects`);
      if (response.ok) {
        const data = await response.json();
  ...
  const handleSendMessage = async (message: string, images: string[] = []) => {
    try {
      // Use the existing API service with contractor context
      const result = await apiService.sendChatMessage(message, images, contractorId, sessionId);
      ...
      console.error('[ContractorDashboard] Error sending message:', error);
      throw error;
    }
  };
                  ...
                  <div>
                    ...
                    <div className="grid gap-6 lg:grid-cols-2">
                      {bidCards.map((bidCard) => (
                        <div key={bidCard.id} className="bg-white rounded-lg shadow hover:shadow-md transition-shadow">
                          <div className="p-6">
                            <div className="flex items-start justify-between mb-4">
                              <h3 className="text-lg font-semibold text-gray-900">
                                {bidCard.project_type}
                              </h3>
                              <span className="text-sm text-gray-500">{bidCard.bid_card_number}</span>
                            </div>
        ...
        {activeTab === 'chat' && (
          <div>
            <div className="mb-6">
              ...
              <p className="text-gray-600">Your Contractor Onboarding & Intelligence Agent with voice capabilities</p>
            </div>
            
            <div className="max-w-4xl mx-auto">
              <UltraInteractiveCIAChat 
                onSendMessage={handleSendMessage}
                initialMessage="Welcome to the Contractor Portal! I'm CoIA, your Contractor Onboarding & Intelligence Agent. I can help you optimize your profile, understand project opportunities, and grow your business on InstaBids. What would you like to work on today?"
              />
            </div>
          </div>
        )}
        ...
        {activeTab === 'profile' && (
          <div>
            <div className="mb-6">
              ...
              <p className="text-gray-600">AI-researched contractor profile and business information</p>
            </div>
            ...
            {isLoading ? (
                  ...
                  <div className="p-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <a href={contractorData.website} className="text-primary-600 hover:text-primary-700" target="_blank" rel="noopener noreferrer">
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex gap-4">
                        {contractorData.social_media.facebook && (
                          <a href={contractorData.social_media.facebook} target="_blank" rel="noopener noreferrer" 
                             className="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                            Facebook
                          </a>
                        )}
                        {contractorData.social_media.instagram && (
                          <a href={contractorData.social_media.instagram} target="_blank" rel="noopener noreferrer"
                             className="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                            Instagram
                          </a>
                        )}
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-green-700 text-sm">Profile data intelligently gathered from web research</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow p-12 text-center">
                ...
                <h2 className="text-xl font-semibold text-gray-900 mb-2">No profile data available</h2>
