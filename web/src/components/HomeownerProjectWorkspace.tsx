...
const HomeownerProjectWorkspace: React.FC<HomeownerProjectWorkspaceProps> = ({ bidCardId }) => {
  ...
  const loadBidCard = async () => {
    try {
      // For demo purposes, load the bid card directly by ID from Supabase
      // In production, this would use the proper API endpoint with auth
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                {extractedData.material_preferences &&
                  extractedData.material_preferences.length > 0 && (
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                      <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
