      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-600 p-6 text-white">
        <div className="flex justify-between items-start mb-4">
          ...
          <div className="text-right">
            ...
            {complexity && (
              <div className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-semibold mt-2 ${complexity.color}`}>
                {complexity.text}
              </div>
            )}
        ...
        <div className="grid grid-cols-4 gap-3">
          ...
          <div className="bg-white/10 rounded-lg p-3 text-center">
            ...
            <div className={`text-xs font-semibold px-2 py-1 rounded ${getUrgencyColor(bidCard.urgency_level)}`}>
        ...
        <div className="relative">
          <div className="h-48 bg-gray-100">
            ...
            {validPhotos.length > 1 && (
              <>
                <button
                  onClick={() => setCurrentPhotoIndex(prev => prev === 0 ? validPhotos.length - 1 : prev - 1)}
                  className="absolute left-2 top-1/2 transform -translate-y-1/2 bg-black/50 text-white p-2 rounded-full hover:bg-black/70"
                >
                  <ChevronLeft className="w-4 h-4" />
                </button>
                <button
                  onClick={() => setCurrentPhotoIndex(prev => prev === validPhotos.length - 1 ? 0 : prev + 1)}
            ...
            {(extractedData.material_preferences || extractedData.materials_preferences) && (
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {(extractedData.material_preferences || extractedData.materials_preferences || []).map((material, index) => (
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <span className="ml-2 text-gray-900">{extractedData.property_details.type || 'N/A'}</span>
                    </div>
                    <div>
                      <span className="font-medium text-gray-600">Service:</span>
                      <span className="ml-2 text-gray-900">{extractedData.service_type || 'N/A'}</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <span className="ml-2 text-gray-900">{extractedData.contractor_requirements.contractor_count || 0}</span>
                    </div>
                    <div>
