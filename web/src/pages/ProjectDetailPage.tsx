...
import { ArrowLeft, Clock, DollarSign, MapPin, Users, MessageSquare, CheckCircle, AlertCircle } from 'lucide-react'
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              {bidCards.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-sm text-gray-400">We're reaching out to qualified contractors</p>
                </div>
              ) : (
                  ...
                  {bidCards.map((bid) => (
                    <div
                      ...
                      className={`border rounded-lg p-4 cursor-pointer transition-all ${
                        selectedBid === bid.id ? 'border-primary-500 bg-primary-50' : 'border-gray-200 hover:border-gray-300'
                      }`}
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            <h3 className="font-medium text-gray-900">{bid.contractor.company_name}</h3>
                            {bid.contractor.verified && (
                              <CheckCircle className="w-4 h-4 text-green-500" title="Verified Contractor" />
                            )}
                          </div>
                          <p className="text-sm text-gray-600 mb-2">{bid.contractor.contact_name}</p>
                        ...
                        <div className="mt-4 pt-4 border-t border-gray-200">
                          ...
                          <div className="flex gap-3">
                            ...
                            <button
                              onClick={(e) => {
                                e.stopPropagation()
                                window.location.href = `tel:${bid.contractor.phone}`
                              }}
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700">
                    Our AI assistant can help you compare bids and make the best choice for your project.
                  </p>
                </div>
              </div>
            </div>
