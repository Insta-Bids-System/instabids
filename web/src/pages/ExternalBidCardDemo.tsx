    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">External Bid Card Examples</h1>
          ...
          <div className="text-sm text-gray-500 bg-yellow-50 rounded-lg p-4 max-w-2xl mx-auto">
            <strong>Note:</strong> Clicking these will take you to the dynamic landing page with
            animations and full signup flow
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          <div className="space-y-4">
            ...
            <ExternalBidCard bidCard={sampleBidCard} variant="web_embed" source="demo_web" />
          </div>
          ...
          <div className="space-y-4">
            ...
            <ExternalBidCard bidCard={bathBidCard} variant="web_embed" source="demo_web" />
          </div>
          ...
          <div className="space-y-4">
            ...
            <ExternalBidCard bidCard={roofBidCard} variant="web_embed" source="demo_web" />
          </div>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="max-w-2xl mx-auto bg-gray-100 p-8 rounded-lg">
            <ExternalBidCard bidCard={sampleBidCard} variant="email" source="demo_email" />
          </div>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="max-w-md mx-auto bg-white p-6 rounded-lg shadow-lg border">
            ...
            <div className="p-4 bg-gray-50 rounded-b-lg">
              <ExternalBidCard bidCard={bathBidCard} variant="sms" source="demo_sms" />
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Auto-rotating project photos with manual navigation
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Full attribution from view to contractor signup
              </p>
            </div>
