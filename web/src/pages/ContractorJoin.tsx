...
import { Calendar, Clock, MapPin, DollarSign, Users, CheckCircle, ArrowRight } from 'lucide-react';
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 mb-8 border border-blue-100">
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <div className="flex justify-between items-start mb-4">
                ...
                <span className={`px-3 py-1 rounded-full text-sm font-medium border ${getUrgencyColor(bidCard.urgency)}`}>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Submit unlimited quotes for free. Pay only when you get the job.</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">All homeowners have confirmed budgets and are ready to hire.</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Only get opportunities in your service area and trade.</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Get started in under 2 minutes. Start bidding immediately.</p>
                </div>
              </div>
            </div>
          </div>
